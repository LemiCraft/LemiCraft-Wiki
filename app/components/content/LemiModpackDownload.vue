<template>
  <div class="lemi-modpack-download">
    <a
      v-if="data"
    ...
    <div v-else-if="error" class="download-error">
      ...
      <a href="https://lemicraft.ru" target="_blank" rel="noopener noreferrer">
        Скачать с сайта ↗
      </a>
    </div>
...
<script setup>
  const { data, error } = await useAsyncData('lemi-modpack', () =>
    $fetch('https://lemicraft.ru/api/launcher/modpack/version')
  )
